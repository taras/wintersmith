...
(function() {
  ...
  ContentPlugin = (function() {
    ...
    ContentPlugin.prototype.getView = function() {
      ...
      /* Return a view that renders the plugin. Either a string naming a exisitng view or a function:
          ...
          Where *environment* is the current embersmith environment, *contents* is the content-tree
    ...
    ContentPlugin.prototype.serialize = function() {

      /* Return just values returned by serializer for this page type */
      return this.constructor.serialize.call(this);
    };
  ...
  ContentPlugin.serialize = function() {
